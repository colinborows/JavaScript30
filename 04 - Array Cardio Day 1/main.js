    ...
    const inventors = [
      ...
      // 1. Filter the list of inventors for those who were born in the 1500's
          ...
          function pre1500(inv) {
            return (inv.year >= 1500 && inv.year < 1600)
          }        
  
          let pre1500s = inventors.filter(pre1500)
  
        //   console.log(pre1500s)

      // Array.prototype.map()
      // 2. Give us an array of the inventors first and last names

          const namesArr = inventors.map(elem => {
    ...
    //   console.log(oldToYoung)
      ...
      // 4. How many years did all the inventors live all together?
        ...
        const compiledAge = inventors.reduce((acc, curr) => {
           return acc + (curr.passed - curr.year);
        }, 0);

        // console.log(compiledAge)
      ...
      // 5. Sort the inventors by years lived
        ...
        // const testMap = yearsLived.map(inventor => (inventor.passed - inventor.year))
